...
public class Servidor extends Computadora {
    ...
    public Servidor(String numeroFuentesPoder, int numeroTarjetasRed, int tipoRaid, String marca, String modelo, Monitor Pantalla, Mouse raton, Teclado teclado, Procesador cpu) {
